...
namespace demo
{
	...
	ColourPanel::ColourPanel()
	{
		...
		mColourRect->eventMouseButtonPressed += MyGUI::newDelegate(this, &ColourPanel::notifyMouseButtonPressed);//eventMouseButtonPressed
		...
		mOk->eventMouseButtonClick += MyGUI::newDelegate(this, &ColourPanel::notifyMouseButtonClick);////eventMouseButtonClick
		int a=0;
		//mOk->eventmouseButton
